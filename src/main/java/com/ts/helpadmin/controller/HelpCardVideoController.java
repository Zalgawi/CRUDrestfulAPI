...
//@RestController
////@RequestMapping(value = "/help-card/videos", method = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE})
//@RequestMapping("/help-card/videos")
//@Slf4j
//public class HelpCardVideoController {
...
//    public List<HelpCardVM> getAllCard() throws Exception  {
//             
//        return helpAdminMockService.getAllCards();
//    } 
//    
